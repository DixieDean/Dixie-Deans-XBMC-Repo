...
def Main():
    ...
    AddAddon('Search',     'plugin.program.super.favourites', _SUPERSEARCH, icon=os.path.join(IMAGES, 'OTTV-Search.png'),      desc='Search all your favourite addons all from one place')
    AddAddon('Favourites', 'plugin.program.super.favourites', _ADDON,       icon=os.path.join(IMAGES, 'OTTV-Favourites.png'))
...
def ShowShortcuts():
    ...
    AddDir('Add more...', '', _ADDSHORTCUT, iconimage=icon, description='Browse and select another addon shortcut', isFolder=False, isPlayable=False)
